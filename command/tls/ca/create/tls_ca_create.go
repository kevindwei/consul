...
func (c *cmd) init() {
	...
	c.flags.IntVar(&c.days, "days", 1825, "Provide number of days the CA is valid for from now on.")
	c.flags.StringVar(&c.prefix, "prefix", "consul", "Prefix for the generated cert and key.")
